...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fitbuddyai-privacy-accepted', onAccepted);
    return () => window.removeEventListener('fitbuddyai-privacy-accepted', onAccepted);
  }, []);
    ...
    <div className="terms-page">
      <header className="terms-hero">
        <div className="terms-hero-inner">
          ...
          <div>
            <h1 className="hero-title">FitBuddyAI Privacy Policy</h1>
            <p className="hero-sub">How we collect, use, and protect your data — short summary.</p>
          </div>
        </div>
      </header>
      ...
      <section className="terms-full">
        <div className="terms-full-inner">
          ...
          <p>This Privacy Policy explains how FitBuddyAI, LLC collects, uses, discloses, and protects the personal information of users of the Service. By using the Service you consent to the collection and use of information as described in this policy.</p>
